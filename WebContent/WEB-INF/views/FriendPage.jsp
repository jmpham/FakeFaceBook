...
<html>
	<head>
		...
		<link rel="stylesheet" href="/Valhalla/staticResources/css/FriendPage.css" type='text/css'/>
	...
	<body>
		...
		<div id="forms">	
			...
			<form  action="/Valhalla/Userpage" enctype="multipart/form-data" method=POST>
